...
def mni_registration(greedy, atlas_t1, path_org_t1, path_org_flair,
    ...
    ----------
    greedy : str
        Command for the registration tool.
    atlas_t1 : str
...
def warp_mni_to_orig(greedy, image_org_space, image_to_mni_affine, seg_mni, seg_orig):
...
def warp_orig_to_mni(greedy, image_org_space, image_to_mni_affine, seg_orig, seg_mni):
