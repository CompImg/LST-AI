...
if __name__ == '__main__':
    ...
    for dir in dirs:  # iterate over subdirs
        ...
        for subdir in subdirs:
            ...
            t1w_file_nnunet = os.path.join(path_out_imagesTr,f'{args.taskname}_{scan_cnt:03d}_0000.nii.gz')
            flair_file_nnunet = os.path.join(path_out_imagesTr,f'{args.taskname}_{scan_cnt:03d}_0001.nii.gz')
            seg_file_nnunet = os.path.join(path_out_labelsTr,f'{args.taskname}_{scan_cnt:03d}.nii.gz')
            ...
            conversion_dict[str(t1w_file)] = t1w_file_nnunet
            conversion_dict[str(flair_file)] = flair_file_nnunet
    ...
    with open(os.path.join(path_out,"conversion_dict_train.json"), "w") as outfile:
